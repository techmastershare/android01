...
import com.davidlee.model.ItemListAdapter;
...
public class TodoList extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (v.getId() == R.id.btnEdit) {
					...
					intent.putExtra("value", idItemSelected);
					Bundle b = new Bundle();
					b.putParcelableArrayList("send", lstTask);
					intent.putExtras(b);
					startActivity(intent);
        ...
        lvTodo.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> adapter, View v, int postion, long id) {
